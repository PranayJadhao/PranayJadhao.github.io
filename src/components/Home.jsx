...
const Home = () => {
  return (
    <div  name='home' className=' h-screen w-full bg-zinc-500  px-20 '>

        <div  className='max-w-scrren-lg max-auto flex flex-col items-center justify-center h-full px-4 md:flex-row'>
            <div className='flex flex-col justify-center h-full'>
                <h2 className='text-4xl sm:text-7xl  font-bold text-white pt-20'>I'm a Full Stack Web Developer</h2>
